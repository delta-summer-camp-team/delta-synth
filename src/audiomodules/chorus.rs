...
impl Chorus {
    pub fn new(sample_rate: f32, max_delay_ms: f32, base_delay_sec: f32, variation_sec: f32, lfo_freq: f32, feedback: f32, mix: f32) -> Self {
    ...
    fn process(&mut self, input: &mut [f32]) -> f32 {
        for sample in input.iter_mut() {
            ...
            *sample = (1.0 - self.mix) * sample + self.mix * wet;
            ...
            if self.lfo_phase > TAU { self.lfo_phase -= TAU; }
